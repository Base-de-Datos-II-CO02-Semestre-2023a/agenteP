        ...
        http.csrf().disable()
                ...
                .authorizeHttpRequests((authorize) -> authorize
                    ...
                    .requestMatchers(HttpMethod.GET, "/empleados", "/empleados/**","/contrato/reportemodificaciones","/contrato/concluir","/contrato/concluir/{id}","/productividad/promedio","/contrato/vacaciones/**", "contrato/diasvacaciones/**",
                            ...
                            "/lugar", "/inventario/articulosDistintos", "/reabastecimiento/crearReabastecimiento","/externo/datosProveedor/**", "/externo/ExistenciaProveedor/**","/inventario/sumaArticulos/**, /inventario/descripcionArticulos/**").hasAnyAuthority("Recursos_Humanos", "Admin")
